...
public class Task7_3__7_4 {
    public static void main(String[] args) {
        MutableArray arr1 = new MutableArray();
        arr1.addValues(new int[]{3,4,5,6,7});
        System.out.println(arr1);
        int[] a = new int[]{8,9,10,11,12};
        arr1.addValues(3, a);
        a[3] = 10000;
        System.out.println(arr1);
        //arr1.addValue(10);
        ...
        arr1.removeValue(4);
        System.out.println(arr1);
        MutableArray arr2 = new MutableArray(arr1);
